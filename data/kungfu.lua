...
['基本轻功'] = {
	...
	source = {
		...
		{ min = 50, max = 99, location = '桃花岛练武场', attr = 'int', gain = 2.5, cmd = 'jump zhuang;jump down', handler = 'thd_practice', cost = { jingli = 55 } },
...
['基本掌法'] = {
	...
	source = {
		...
		{ min = 0, max = 101, location = '福州城巨岩', attr = 'str', gain = 1.5, cmd = 'strike rock', handler = 'fz_rock', cost = { jingli = 50 }, cond = 'player.neili_max > 300' }, -- in fact this one is based on str and con, with bonus if player is drunk
